...
export type BibleVerseActionSheetProps = {
  ...
  onCopyPress: () => void
  onSharePress: () => void
  /** Swipe-down, backdrop tap, or displacement by another sheet. All are a cancel. */
  onClose: () => void
  theme: Theme
}
 ...
 * actions have always been a native bottom sheet. See ADR 0015.
 *
 * **Presentational only.** It decides nothing: which swatches to show is
 * `lib/verse-action-swatches.ts`, what a swatch press means is
 * `native/use-reader-highlights.ts`, and clearing the selection afterwards is
 * the reader's job.
 */
