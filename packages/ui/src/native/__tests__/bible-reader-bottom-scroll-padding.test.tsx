...
describe('BibleReader bottom scroll padding', () => {
  ...
  it('places overlay nav above the iOS tab bar overlay', () => {
    const originalOS = Platform.OS
    Object.defineProperty(Platform, 'OS', { configurable: true, value: 'ios' })
    ...
    const previous = screen.getByTestId('reader-toolbar-previous-chapter')
    expect(StyleSheet.flatten(previous.props.style).bottom).toBe(
